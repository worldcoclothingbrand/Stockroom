...
function renderAccessDenied(email) {
  document.body.innerHTML =
    '<div class="login-screen">' +
      '<div class="login-card">' +
        '<div class="login-mark" style="background:#ff5c7a;color:#fff;">X</div>' +
        ...
        '<button class="login-btn" id="signout-denied-btn" style="margin-top:8px;">Sign out and try another account</button>' +
      '</div>' +
    '</div>';
